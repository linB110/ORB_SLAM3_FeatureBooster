    ...
    mbActivateLocalizationMode(false), mbDeactivateLocalizationMode(false), mbShutDown(false)
{
    ...
    std::string enginePath = "/home/lab605/ORB_SLAM3_FeatureBooster/model/feature_booster_fp16.engine";  
    mpFeatureBooster = new ORB_SLAM3::FeatureBooster(752,480,enginePath);
    ...
    //mpTracker = new Tracking(this, mpVocabulary, mpFrameDrawer, mpMapDrawer,
    //                         mpAtlas, mpKeyFrameDatabase, strSettingsFile, mSensor, settings_, strSequence, mpFeatureBooster);
